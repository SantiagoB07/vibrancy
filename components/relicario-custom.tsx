...
export function RelicarioCustom({ product, children }: RelicarioCustomProps) {
  ...
  // Inicializar estados sin localStorage
  ...
  return (
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="sm:max-w-3xl w-full max-h-[90vh] p-0 bg-transparent border-none overflow-hidden">
          <div className="bg-white rounded-2xl shadow-2xl max-h-[90vh] flex flex-col">
            ...
            <div className="relative">
                ...
                <div className="px-4 md:px-6 py-3 md:py-4 pr-12 md:pr-16">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-3 sm:gap-4">
                      ...
                      <button
                          onClick={() => console.log("Pagar", { product, variant, petName, ownerInfo, uploadedImage })}
              ...
              <div className="flex-1 overflow-y-auto p-4 md:p-8 pb-6 md:pb-12 max-h-[calc(90vh-80px)]">
                {/* Pet Tag Preview con imagen y texto superpuesto */}
                <div className="flex justify-center mb-6 md:mb-8">
                  <div className="relative w-full max-w-[320px] md:max-w-[520px] aspect-[520/280] perspective-1000"
                ...
                <div className="px-0 md:px-8 pb-4 md:pb-6">
