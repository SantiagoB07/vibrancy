        ...
        <main className="min-h-screen flex items-center justify-center bg-[#E6C29A] px-4">
            <div className="max-w-md w-full bg-[#F9E3C8] rounded-3xl shadow-2xl border border-[#B9804A]/30 p-8 text-center">
                ...
                <p className="text-sm text-[#6F4A2A] mb-6">
                    Tu pago fue rechazado o no se terminó de completar.
                    Puedes intentar nuevamente con otro medio de pago o revisar los datos
                    de tu tarjeta / cuenta.
                </p>

                <div className="mb-6 text-xs text-[#7C5431]">
                    Si el problema persiste, escríbenos y te ayudamos a finalizar tu compra.
                </div>

                <div className="flex flex-col gap-3">
                    <button
                        onClick={() => history.back()}
                        className="w-full py-2.5 rounded-full border border-[#5E3A1E] text-[#5E3A1E] text-sm font-medium hover:bg-[#EED3B1] transition"
                    >
                        Intentar de nuevo
                    </button>
